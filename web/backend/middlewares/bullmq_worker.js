  ...
  try {
    ...
    switch (__type) {
      case 'bulk_product':
        ...
        break
      case 'bulk_product_with_metafields':
        await BulkProduct.createWithMetafields(backgroundJob.data, backgroundJob.id)
        break
      case 'bulk_product_update_with_metafield':
        await BulkProduct.updateWithMetafields(backgroundJob.data, backgroundJob.id)
        break
      default:
